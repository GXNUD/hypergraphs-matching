...
def draw_edges_match(matches, kp1, kp2, E1, E2, img1, img2):
    ...
    for mat in matches:
        ...
        (x1_2, y1_2) = kp2[E1[__trainIdx][0]].pt
        (x2_2, y2_2) = kp2[E1[__trainIdx][1]].pt
        (x3_2, y3_2) = kp2[E1[__trainIdx][2]].pt
...
if __name__ == "__main__":
    ...
    (kpts1, des1) = get_features(img1_gray, M, './target.jpg', show=True)
    (kpts2, des2) = get_features(img2_gray, M, './reference.jpg', show=True)
